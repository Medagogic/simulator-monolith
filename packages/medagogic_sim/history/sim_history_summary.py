...
if TYPE_CHECKING:
    from packages.medagogic_sim.history.sim_history import HistoryLog, HistoryEvent, EventTypes, Evt_CompletedIntervention, Evt_Assessment
...
if __name__ == "__main__":
    async def test_history_condenser():
        from packages.medagogic_sim.history.sim_history import HistoryLog, HistoryEvent, EventTypes, Evt_CompletedIntervention, Evt_Assessment, Evt_Chat_HumanMessage

        # Create a HistoryLog and populate it with some events
        history_log = HistoryLog()
        history_log.add_event(Evt_Chat_HumanMessage(content="Hello, world"))
